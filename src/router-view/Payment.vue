        ...
        <form action="#" method="POST">
            <div class="riepilogo_invisible">
                ...
                <ul v-for="details in store.cart" :key="details.id">
                    <li>
                        <input type="text" id="details.quantity" name="amount" readonly="readonly" disabled :value="details.quantity">
                        <br><br>
                        <label for="dish_name"></label>
                        <input type="text" id="dish_name" name="dish_name" readonly="readonly" disabled :value="details.name">
                        <br><br>
                        <label for="dish_price"></label>
                        <input type="text" id="dish_price" name="dish_price" readonly="readonly" disabled :value="details.price">
                        <br><br>
